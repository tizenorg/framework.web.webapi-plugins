...
//add_test_case(moduleName, PowerManager_getScreenBrightness); //Not supported for Power API
...
//add_test_case(moduleName, PowerManager_isScreenOn); //Not supported for Power API
...
//add_test_case(moduleName, PowerManager_setScreenBrightness); //Not supported for Power API
...
//add_test_case(moduleName, PowerManager_setScreenBrightness_brightness_invalid_val); //Not supported for Power API
//add_test_case(moduleName, PowerManager_getScreenBrightness_check_change); //Not supported for Power API
//add_test_case(moduleName, PowerManager_isScreenOn_check_change); //Not supported for Power API
//add_test_case(moduleName, PowerManager_turnScreenOff_successful); //Not supported for Power API
//add_test_case(moduleName, PowerManager_turnScreenOn_successful); //Not supported for Power API
add_test_case(moduleName, PowerManager_unsetScreenStateChangeListener_successful);
//add_test_case(moduleName, PowerManager_restoreScreenBrightness_check_effect); //Not supported for Power API